...
const STRINGS = {
  en: {
    ...
    "legend.edges": "Edges",
    "edges.help": "An enabled kind is drawn, acts as a spring in the physics and counts for degrees, call heights and the diagnostics; a disabled kind does none of these. Type-level edges are off by default because they are erased at run time.",
  ...
  ja: {
    ...
    "legend.edges": "エッジ",
    "edges.help": "有効な種別は描画され、物理でばねとして働き、次数・呼び出し高さ・診断に数えられます。無効な種別はそのどれにも関与しません。型のエッジは実行時に消えるため既定でオフです。",
