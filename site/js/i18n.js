...
const STRINGS = {
  en: {
    ...
    "metric.elevationGaps.gap": "gap {gap}",
    "metric.elevationGaps.show": "Highlight these in the view",
  ...
  ja: {
    ...
    "metric.elevationGaps.gap": "差 {gap}",
    "metric.elevationGaps.show": "ビューで強調表示する",
