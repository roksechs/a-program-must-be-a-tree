...
const STRINGS = {
  en: {
    ...
    "metric.edges": "Edges",
    "metric.controlEdges": "Control edges",
    "metric.controlEdges.hint": "Calls and constructions: the edges that transfer control at run time.",
    ...
    "metric.scope": "Computed on the control graph (calls and constructions). References, types and inheritance are drawn but do not count as callers.",
  ...
  ja: {
    ...
    "metric.edges": "エッジ",
    "metric.controlEdges": "制御エッジ",
    "metric.controlEdges.hint": "呼び出しと生成。実行時に制御が移るエッジ。",
    "metric.initCycles": "初期化サイクル",
    "metric.initCycles.hint": "定義時依存の循環に含まれる宣言。初期化前に読まれます。",
    "metric.scope": "制御グラフ（呼び出しと生成）で計算しています。参照・型・継承は描画されますが呼び出し元としては数えません。",
